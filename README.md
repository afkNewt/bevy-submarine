This project so far is an implementation of the marching squares algorithm and Sebastian Lagues cave generation algorithm, with the ability to destroy terrain by hovering over it with the cursor.
